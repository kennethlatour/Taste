...
function Quiz({setTypeState}) {
    ...
    function changeSecondState () {
        ...
        <Marquee gradient = {noblur} direction = "left" >  
                ...
                <img className="img1" alt = "Second Round" onClick = {changeFirstState} src= {firstState}/> 
                <img className="img2" alt = "Second Round" onClick = {changeSecondState} src= {secondState}/> 
